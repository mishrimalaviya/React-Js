        ...
        <div class="w-50 h-100  p-5">
            ...
            {state ?
                ...
                <div>
                    ...
                    <input placeholder="Enter the email" class="form-control rounded-pill mt-2" onChange={(e)=>setemail(e.target.value)}></input><br></br>
                    <span style={{fontSize:"13px"}} class="ps-3 ">Password</span><br></br>
                    <input placeholder="Enter the Pasword" class="form-control rounded-pill mt-2" type="password" onChange={(e)=>setpassword(e.target.value)}></input><br></br>
                    <button class="form-control btn rounded-pill" style={{background:"rgb(255, 216, 95)"}} onClick={check}>Submit</button>
                ...
                <div>
                    ...
                    <input placeholder="Enter the Username" class="form-control rounded-pill mt-2" onChange={(e)=>setusename(e.target.value)}></input><br></br>
                    <span style={{fontSize:"13px"}} class="ps-3 ">Email</span><br></br>
                    <input placeholder="Enter the email" class="form-control rounded-pill mt-2" onChange={(e)=>emails(e.target.value)}></input><br></br>
                    <span style={{fontSize:"13px"}} class="ps-3 ">Password</span><br></br>
                    <input placeholder="Enter the Pasword" class="form-control rounded-pill mt-2" type="password" onChange={(e)=>passwords(e.target.value)}></input><br></br>
