        ...
        <div className="w-50 h-100  p-5">
            ...
            {state ?
                ...
                <div>
                    ...
                    <input placeholder="Enter the email" className="form-control rounded-pill mt-2" onChange={(e)=>setemail(e.target.value)}></input><br></br>
                    <span style={{fontSize:"13px"}} className="ps-3 ">Password</span><br></br>
                    <input placeholder="Enter the Pasword" className="form-control rounded-pill mt-2" type="password" onChange={(e)=>setpassword(e.target.value)}></input><br></br>
                ...
                <div>
                    ...
                    <input placeholder="Enter the Username" className="form-control rounded-pill mt-2" onChange={(e)=>setusename(e.target.value)}></input><br></br>
                    <span style={{fontSize:"13px"}} className="ps-3 ">Email</span><br></br>
                    <input placeholder="Enter the email" className="form-control rounded-pill mt-2" onChange={(e)=>emails(e.target.value)}></input><br></br>
                    <span style={{fontSize:"13px"}} className="ps-3 ">Password</span><br></br>
                    <input placeholder="Enter the Pasword" className="form-control rounded-pill mt-2" type="password" onChange={(e)=>passwords(e.target.value)}></input><br></br>
